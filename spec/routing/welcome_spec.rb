...
describe WelcomeController do
  ...
  describe 'routes' do
    it 'routes' do
      ...
      expect( :get => '/en/' ).to route_to( :controller => 'cities', :action => 'index' )
      expect( :get => '/en/cities' ).to route_to( :controller => 'cities', :action => 'index' )
      expect(:get => '/cities.json').to route_to('cities#index', 'format' => 'json')
      expect(:get => '/en/cities.json').to route_to('cities#index', 'format' => 'json')
