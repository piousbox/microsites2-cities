...
describe "Cities Home Views", ->
  ...
  beforeEach ->
    ...
    @sites_newsitems_collection = new Collections.Sites.Newsitems({ domain: 'travel-guide.mobi' })
  ...
  describe "templates", ->
    ...
    expect( $('#sites_newsitems_index-template').length ).toEqual( 1, 'Sites Newsitems Index template must be defined' )
  ...
  it '#newsitems', ->
    newsitems_view = new Views.Sites.Newsitems({ collection: @site_newsitems_collection })
